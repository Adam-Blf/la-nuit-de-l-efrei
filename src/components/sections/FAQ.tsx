...
const ITEMS = [
  ...
  },
  {
    ...
    a: "Avec votre billet · 2 consos offertes à l'embarquement (1 mousseux ou cocktail de vin + 1 soft), 6 petits-fours servis pendant le cocktail dînatoire, les bouteilles d'eau plate à volonté gratuitement, l'accès aux 2 ponts de la péniche, le DJ et le live de Live EFREI sur le pont supérieur, le photographe officiel. Le bar (consos suivantes à 2 € · cocktails déclinés en version sans alcool sur demande) est ouvert jusqu'à 03h30.",
  },
  {
