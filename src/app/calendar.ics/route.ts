...
export function GET(_req: NextRequest) {
  ...
  const lines = [
    ...
    `DESCRIPTION:${ESC(
      "Le retour, dix ans plus tard. Soirée privatisée par Prom EFREI. Portes 22h00, fin 04h00. Dress code : robe élégante ou costume. Conso 2 €. Plus d'infos : https://prom.efrei.fr",
    )}`,
